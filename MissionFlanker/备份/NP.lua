...
do
  ...
  function activateBlueCenterFlight()
    ...
    trigger.action.setUserFlag("苏呼米(中间) MI24P Blue #001", 0)
    trigger.action.setUserFlag("苏呼米(中间) MI24P Blue #002", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #001", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #002", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #003", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #004", 0)

    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-1", 0)
    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-2", 0)
    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-3", 0)
    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-4", 0)
  end
  ...
  function activateRedCenterFlight()
    ...
    trigger.action.setUserFlag("苏呼米(中间) MI24P Red #001", 0)
    trigger.action.setUserFlag("苏呼米(中间) MI24P Red #002", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #001", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #002", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #003", 0)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #004", 0)

    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-1", 0)
    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-2", 0)
    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-3", 0)
    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-4", 0)
  end
  ...
  function activateBlueCenter2Flight()
    ...
    trigger.action.setUserFlag("科尔奇(中间) MI24P Blue #001", 0)
    trigger.action.setUserFlag("科尔奇(中间) MI24P Blue #002", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #001", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #002", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #003", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #004", 0)

    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-1", 0)
    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-2", 0)
    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-3", 0)
    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-4", 0)
  end
  ...
  function activateRedCenter2Flight()
    ...
    trigger.action.setUserFlag("科尔奇(中间) MI24P Red #001", 0)
    trigger.action.setUserFlag("科尔奇(中间) MI24P Red #002", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #001", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #002", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #003", 0)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #004", 0)

    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-1", 0)
    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-2", 0)
    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-3", 0)
    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-4", 0)
  ...
  function deactivateBlueCenterFlight()
    ...
    trigger.action.setUserFlag("苏呼米(中间) MI24P Blue #001", 100)
    trigger.action.setUserFlag("苏呼米(中间) MI24P Blue #002", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #001", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #002", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #003", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Blue #004", 100)

    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-1", 100)
    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-2", 100)
    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-3", 100)
    trigger.action.setUserFlag("蓝方苏呼米前线运输机(模拟)-4", 100)
  end
  ...
  function deactivateRedCenterFlight()
    ...
    trigger.action.setUserFlag("苏呼米(中间) MI24P Red #001", 100)
    trigger.action.setUserFlag("苏呼米(中间) MI24P Red #002", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #001", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #002", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #003", 100)
    trigger.action.setUserFlag("苏呼米(中间) AH64D Red #004", 100)

    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-1", 100)
    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-2", 100)
    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-3", 100)
    trigger.action.setUserFlag("红方苏呼米前线运输机(模拟)-4", 100)
  end
  ...
  function deactivateBlueCenter2Flight()
    ...
    trigger.action.setUserFlag("科尔奇(中间) MI24P Blue #001", 100)
    trigger.action.setUserFlag("科尔奇(中间) MI24P Blue #002", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #001", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #002", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #003", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Blue #004", 100)

    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-1", 100)
    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-2", 100)
    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-3", 100)
    trigger.action.setUserFlag("蓝方科尔奇前线运输机(模拟)-4", 100)
  end
  ...
  function deactivateRedCenter2Flight()
    ...
    trigger.action.setUserFlag("科尔奇(中间) MI24P Red #001", 100)
    trigger.action.setUserFlag("科尔奇(中间) MI24P Red #002", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #001", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #002", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #003", 100)
    trigger.action.setUserFlag("科尔奇(中间) AH64D Red #004", 100)

    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-1", 100)
    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-2", 100)
    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-3", 100)
    trigger.action.setUserFlag("红方科尔奇前线运输机(模拟)-4", 100)
  end
  ...
  function activateBlueCenter3Flight()
    ...
    trigger.action.setUserFlag("苏呼米(本场) SA342Mistral Blue #001", 0)
    trigger.action.setUserFlag("苏呼米(本场) SA342Mistral Blue #002", 0)
    ...
    trigger.action.setUserFlag("苏呼米(本场) MI24P Blue #001", 0)
    trigger.action.setUserFlag("苏呼米(本场) MI24P Blue #002", 0)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #001", 0)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #002", 0)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #003", 0)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #004", 0)
  end
  ...
  function activateRedCenter3Flight()
    ...
    trigger.action.setUserFlag("科尔奇(本场) SA342Mistral Red #001", 0)
    trigger.action.setUserFlag("科尔奇(本场) SA342Mistral Red #002", 0)
    ...
    trigger.action.setUserFlag("科尔奇(本场) MI24P Red #001", 0)
    trigger.action.setUserFlag("科尔奇(本场) MI24P Red #002", 0)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #001", 0)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #002", 0)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #003", 0)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #004", 0)
  end
  ...
  function deactivateRedCenter3Flight()
    ...
    trigger.action.setUserFlag("科尔奇(本场) SA342Mistral Red #001", 100)
    trigger.action.setUserFlag("科尔奇(本场) SA342Mistral Red #002", 100)
    ...
    trigger.action.setUserFlag("科尔奇(本场) MI24P Red #001", 100)
    trigger.action.setUserFlag("科尔奇(本场) MI24P Red #002", 100)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #001", 100)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #002", 100)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #003", 100)
    trigger.action.setUserFlag("科尔奇(本场) AH64D Red #004", 100)
  end
  ...
  function deactivateBlueCenter3Flight()
    ...
    trigger.action.setUserFlag("苏呼米(本场) SA342Mistral Blue #001", 100)
    trigger.action.setUserFlag("苏呼米(本场) SA342Mistral Blue #002", 100)
    ...
    trigger.action.setUserFlag("苏呼米(本场) MI24P Blue #001", 100)
    trigger.action.setUserFlag("苏呼米(本场) MI24P Blue #002", 100)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #001", 100)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #002", 100)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #003", 100)
    trigger.action.setUserFlag("苏呼米(本场) AH64D Blue #004", 100)
  end
  ...
  function activateBlueFrontFlight()
    ...
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #001", 0)
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #002", 0)
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #003", 0)
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #004", 0)

    trigger.action.setUserFlag("主战区(前线) MI24P Blue #001", 0)
    trigger.action.setUserFlag("主战区(前线) MI24P Blue #002", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #001", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #002", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #003", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #004", 0)
  end
  ...
  function activateRedFrontFlight()
    ...
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #001", 0)
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #002", 0)
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #003", 0)
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #004", 0)

    trigger.action.setUserFlag("主战区(前线) MI24P Red #001", 0)
    trigger.action.setUserFlag("主战区(前线) MI24P Red #002", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #001", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #002", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #003", 0)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #004", 0)
  end
  ...
  function deactivateBlueFrontFlight()
    ...
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #001", 100)
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #002", 100)
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #003", 100)
    trigger.action.setUserFlag("主战区(前线) JF-17 Blue #004", 100)

    trigger.action.setUserFlag("主战区(前线) MI24P Blue #001", 100)
    trigger.action.setUserFlag("主战区(前线) MI24P Blue #002", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #001", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #002", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #003", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Blue #004", 100)
  end
  ...
  function deactivateRedFrontFlight()
    ...
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #001", 100)
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #002", 100)
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #003", 100)
    trigger.action.setUserFlag("主战区(前线) JF-17 Red #004", 100)

    trigger.action.setUserFlag("主战区(前线) MI24P Red #001", 100)
    trigger.action.setUserFlag("主战区(前线) MI24P Red #002", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #001", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #002", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #003", 100)
    trigger.action.setUserFlag("主战区(前线) AH64D Red #004", 100)
  end
  ...
  function deactivateRedFront3Flight()
    ...
    trigger.action.setUserFlag("主战区(本场) AH64D Red #001", 100)
    trigger.action.setUserFlag("主战区(本场) AH64D Red #002", 100)
    trigger.action.setUserFlag("主战区(本场) AH64D Red #003", 100)
    trigger.action.setUserFlag("主战区(本场) AH64D Red #004", 100)
  end
